...
from .image import check_if_adding_bboxes, check_img_size, process_image
...
def process_video(filename, args, cfg, detector):
    ...
    first_img = check_img_size(images[0])
    ...
    for image in images:
        # Process frames
        img_steps = process_image(image, cfg, detector)
